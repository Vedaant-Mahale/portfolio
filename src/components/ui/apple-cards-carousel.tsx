    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          <button
            className="relative z-40 h-10 w-10 rounded-full bg-transparent flex items-center justify-center disabled:opacity-50"
            onClick={scrollLeft}
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              ...
              <motion.p
                ...
                className="text-xl text-sky-400 dark:text-white"
              >
                {card.category}
              </motion.p>
              <motion.p
                layoutId={layout ? `title-${card.title}` : undefined}
                className="text-2xl md:text-5xl font-semibold text-sky-400 mt-4 dark:text-white"
              >
                {card.title}
              </motion.p>
